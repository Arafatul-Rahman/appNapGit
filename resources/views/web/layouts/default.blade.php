...
<head>
	...
	<link href="{{ asset('backend/assets/css/icons/fontawesome/styles.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <div id="app">
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{route('web.home')}}"><img src="{{ asset('backend/assets/images/logo_light.png') }}" alt=""></a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="{{route('web.profile')}}"><i class="icon-user-plus"></i> My profile</a></li>
                            <li class="divider"></li>
                            <li><a href="{{ route('web.logout') }}" onclick="event.preventDefault();
                        ...
                        <div class="sidebar-category sidebar-category-visible">
                            <div class="category-content no-padding">
                                <ul class="navigation navigation-main navigation-accordion">
                                    ...
                                    <!-- Default -->
                                    {{-- <li class="{{ (request()->is('provider/home')) ? 'active' : '' }}"><a href="{{route('web.home')}}"><i class="icon-home4"></i> <span>Home</span></a></li>
                                    <li class="{{ (request()->is('provider/admin*')) ? 'active' : '' }}"><a href="{{route('web.admin.index')}}"><i class="icon-users"></i> <span>Admin</span></a></li>
                                    <li class="{{ (request()->is('provider/blogCategory*')) ? 'active' : '' }}"><a href="{{route('web.blogCategory.index')}}"><i class="icon-blog"></i> <span>Blog Category</span></a></li>
                                    <li class="{{ (request()->is('provider/blogPost*')) ? 'active' : '' }}"><a href="{{route('web.blogPost.index')}}"><i class="icon-blogger"></i> <span>Blog Post</span></a></li>
                                    <li class="{{ (request()->is('provider/userFeedback*')) ? 'active' : '' }}"><a href="{{route('web.userFeedbackList')}}"><i class="icon-users"></i> <span>Suggestion</span></a></li> --}}
