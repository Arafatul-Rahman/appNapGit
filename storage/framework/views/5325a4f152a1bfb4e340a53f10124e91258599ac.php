...
<head>
	...
	<link href="<?php echo e(asset('backend/assets/css/icons/fontawesome/styles.min.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('backend/assets/summernote/summernote.css')); ?>" />
    <!-- /global stylesheets -->
    <style>
        .add-new {
            color: #fff!important;
...
<body class="navbar-top">
    <div id="app">
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-header">
                <a class="navbar-brand" href="<?php echo e(route('web.home')); ?>"><img src="<?php echo e(asset('backend/assets/images/logo_light.png')); ?>" alt=""></a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown dropdown-user">
                        <a class="dropdown-toggle" data-toggle="dropdown">
                            <?php if( !empty($userInfo->image) || $userInfo->image != Null): ?>
                                <img src="<?php echo e(asset('uploads/providerProfile/'. $userInfo->image)); ?>" class="img-circle img-sm" alt="">
                            <?php else: ?>
                                <img src="<?php echo e(asset('backend/assets/images/placeholder.jpg')); ?>" alt="">
                            <?php endif; ?>
                            <span><?php echo e($userInfo->name); ?></span>
                            <i class="caret"></i>
                        </a>

                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="<?php echo e(route('web.profile')); ?>"><i class="icon-user-plus"></i> My profile</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo e(route('web.logout')); ?>" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"><i class="icon-switch2"></i> Logout</a>
                                <form id="logout-form" action="<?php echo e(route('web.logout')); ?>" method="POST" class="d-none">
                                    <?php echo csrf_field(); ?>
                                </form>
                            </li>
                        </ul>
                            ...
                            <div class="category-content">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="media-heading text-semibold"> <?php echo e(Auth::guard('web')->user()->name); ?> </span>
	...
	<script type="text/javascript" src="<?php echo e(asset('backend/assets/js/plugins/visualization/echarts/echarts.js')); ?>"></script>

    <script type="text/javascript" src="<?php echo e(asset('backend/assets/js/core/app.js')); ?>"></script>
    <!-- Fixed Sidebar JS files -->
    <script type="text/javascript" src="<?php echo e(asset('backend/assets/js/layout_fixed_custom.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\project\webHosting\resources\views/web/layouts/default.blade.php ENDPATH**/ ?>